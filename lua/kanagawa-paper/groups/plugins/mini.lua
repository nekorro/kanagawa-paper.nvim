...
function M.get(colors, opts)
	...
	return {
		...
		MiniIconsAzure = { fg = theme.term.blue_bright },
		MiniIconsBlue = { fg = theme.term.blue },
		MiniIconsCyan = { fg = theme.term.cyan },
		MiniIconsGreen = { fg = theme.term.green },
		MiniIconsGrey = { fg = theme.term.black_bright },
		MiniIconsOrange = { fg = theme.term.indexed1 },
		MiniIconsPurple = { fg = theme.term.magenta_bright },
		MiniIconsRed = { fg = theme.term.red },
		MiniIconsYellow = { fg = theme.term.yellow },
